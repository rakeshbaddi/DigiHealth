...
public class SecretaryWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Locality", "Sender", "Receiver", "Health Status", "Price ", "Comments"
            }
        ) {
        ...
        processRequestBtn.setFont(new java.awt.Font("Skia", 1, 14)); // NOI18N
        ...
        jLabel1.setText("Secretary Work Region");
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, "Please select a row to view the details");
            return;
        } else {
            ...
            if (request.getStatus().equals("Sent to Secretary")) {
                ...
                populateTable();
                JOptionPane.showMessageDialog(null, "Request is assigned to you succesfully");
            } else {
                JOptionPane.showMessageDialog(null, "Cannot assign this work request, as the work request is in " + request.getStatus() + " status", "Warning!", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private void processRequestBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processRequestBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (fundRequest.getStatus().equals("Rejected")) {
                JOptionPane.showMessageDialog(null, "The request cannot be processed further as it is rejected", "Warning!", JOptionPane.WARNING_MESSAGE);
                return;
            }
           ...
           if (fundRequest.getStatus().equalsIgnoreCase("Sent to Treasurer")) {
            ...
            if (!userAccount.getEmployee().equals(fundRequest.getReceiver().getEmployee())) {
                JOptionPane.showMessageDialog(null, "The request assigned is already assigned to other officer", "Warning!", JOptionPane.WARNING_MESSAGE);
                return;
            }
